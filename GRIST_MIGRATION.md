...
Kolla under **Raw Data** i Grist vilka tabell-ID:n ni har (t.ex. `Application_Users`, `KUNDDATA`). Standard i koden: `GRIST_TABLE_USERS=Application_Users`, `GRIST_TABLE_KUNDDATA=KUNDDATA`. Ändra bara om era tabeller heter annorlunda.
