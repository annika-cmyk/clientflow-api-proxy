...
const WHATS_NEW_ENTRIES = [
  {
    date: '2026-08-27',
    importance: 2,
    title: 'Borttagen riskfaktor: kundens kunder på distans',
    summary: 'Riskfaktorn «Kundens egna kunder är på distans» är borttagen från katalogen och visas inte längre i AR-statistik eller distributionsdiagram.'
  },
  {
    date: '2026-08-27',
    importance: 1,
