...
const WHATS_NEW_ENTRIES = [
  ...
  },
  {
    date: '2026-08-24',
    importance: 5,
    title: 'Övriga riskfaktorer i tre kategorier',
    summary: 'På kundkortet bockar ni av övriga riskfaktorer i Hur samarbetar vi?, Vem är kunden? och Vad gör kunden?. Hög-aktiv höjer till Hög. Två som bidrar vid kombination gör samma sak tillsammans.'
  },
  {
    date: '2026-08-24',
    importance: 3,
