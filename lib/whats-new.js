...
const WHATS_NEW_ENTRIES = [
  {
    date: '2026-09-13',
    importance: 4,
    title: 'Borra ner i kundbranscher',
    summary:
      'Under Från byråprofilen kan ni klicka på en bransch (t.ex. Bygg eller Fastighet) och se under-SNI med antal samt vilka kunder som hör dit, med länk till kundkort. Gäller både Kundernas branscher och Högriskbranscher.'
  },
  {
    date: '2026-09-13',
    importance: 4,
