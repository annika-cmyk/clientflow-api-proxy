...
const WHATS_NEW_ENTRIES = [
  ...
  },
  {
    ...
    summary:
      'När Google-kalender är på hämtas dina Google-händelser in i ClientFlow-kalendern (månad/vecka/dag). De märks som GCal så de skiljs från uppdragskörningar. Synka skickar tidblock till Google och hämtar tillbaka övriga händelser — utan dubbletter av det ClientFlow redan pushat.'
  },
  {
    date: '2026-09-16',
    importance: 3,
    ...
    summary:
      'Knappaden Google/Koppla/Synka/Möten/Tid/Uppdragstavla är borttagen från kalenderns topp (sidomenyn finns kvar). Hjälptexten under filtren är också borta så rutnätet får mer plats.'
  },
  {
    date: '2026-09-16',
    importance: 4,
