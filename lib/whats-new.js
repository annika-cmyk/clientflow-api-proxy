...
const WHATS_NEW_ENTRIES = [
  {
    date: '2026-08-21',
    importance: 4,
    title: 'Gul åtgärd visar vilket ord som stoppar sparandet',
    summary: 'Om en åtgärd inte går att spara står det nu vilket ord som läses som en avsikt, till exempel «förbättra». Texter som «vi har implementerat … för att förbättra …» går att spara.'
  },
  {
    date: '2026-08-21',
    importance: 5,
  ...
  },
  {
    date: '2026-08-21',
    importance: 5,
    title: 'Hot måste handla om penningtvätt eller TF',
    summary: 'Ett hot som «felaktiga löneutbetalningar ger ekonomiska förluster och sämre förtroende» går inte att spara. Beskriv hur tjänsten kan användas för att dölja eller legitimera medel, eller finansiera terrorism. AI filtrerar bort drift- och HR-risk.'
  },
  {
    date: '2026-08-21',
    importance: 5,
  ...
  },
  {
    date: '2026-08-21',
    importance: 5,
    title: 'Åtgärder som beskriver vad ni gör kan sparas',
    summary: 'Bara rena avsikter som «inför striktare krav» eller «bör stärka» stoppas. Vanliga texter som «vi informerar alltid…» eller «granska dokumentationen…» går att spara. Vaga rekommendationer behöver fortfarande bli till vad ni gör, eller en plan med när, vem och var.'
  },
  {
    date: '2026-08-21',
    importance: 4,
