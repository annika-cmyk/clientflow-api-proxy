...
const WHATS_NEW_ENTRIES = [
  {
    date: '2026-08-21',
    importance: 4,
    title: 'Tydligare vägledning för tjänsters riskbedömning',
    summary: 'På sidan för byråns tjänster förklaras nu skillnaden mellan penningtvätt och terrorfinansiering, och att inneboende risk och residualrisk ska hållas isär.'
  },
  {
    date: '2026-08-21',
    importance: 5,
