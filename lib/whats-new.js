...
const WHATS_NEW_ENTRIES = [
  {
    date: '2026-08-21',
    importance: 5,
    title: 'Åtgärder måste vara införda eller tydligt planerade',
    summary: 'Vaga avsikter som «Inför striktare krav» går inte att spara. Skriv vad byrån gör, till exempel att underlag dokumenteras i bokslutsprogrammet, eller en plan med när, vem och var.'
  },
  {
    date: '2026-08-21',
    importance: 4,
