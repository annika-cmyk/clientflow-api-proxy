...
const WHATS_NEW_ENTRIES = [
  {
    date: '2026-09-15',
    importance: 5,
    title: 'Kundstatistik som på statistiksidan',
    summary:
      'På Vilka är våra kunder visas nu kundstocken från Clientflow med samma klickbara chips som under Statistik för riskbedömning — bolagsformer, branscher, högriskbransch och PEP. Klicka för underbranscher och kundlista. Bolagsformer syns även på statistiksidan.'
  },
  {
    date: '2026-09-15',
    importance: 5,
