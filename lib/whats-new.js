...
const WHATS_NEW_ENTRIES = [
  {
    ...
    summary: 'På tjänstesidan kan ni fälla ut en översikt utan att öppna redigera, ta bort tjänster från katalogen, och längst ner välja Lägg till standardtjänst eller Skapa egen tjänst. Källa på hot/sårbarhet är valfri.'
  },
  {
    date: '2026-09-12',
    importance: 4,
