...
const WHATS_NEW_ENTRIES = [
  {
    date: '2026-09-13',
    importance: 3,
    title: 'Klarmarkera: botten höger och nästa steg',
    summary:
      'I Din resa ligger Klarmarkera längst ner till höger. När du klarmarkerar ett steg går du automatiskt vidare till nästa i sidomenyn (sista steget stannar kvar). Ta bort klarmarkering flyttar dig inte.'
  },
  {
    date: '2026-09-13',
    importance: 2,
