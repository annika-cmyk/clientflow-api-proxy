...
const WHATS_NEW_ENTRIES = [
  {
    ...
    summary: 'När ett dokument ligger under Aktuell riskbedömning → KYC-formulär bockas ”Finns utanför ClientFlow” i automatiskt och utfört datum hämtas från dokumentets skapade datum. Underkategori går att välja vid uppladdning och redigering.'
  },
  {
    date: '2026-08-26',
    importance: 4,
