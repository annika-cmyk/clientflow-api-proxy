...
const WHATS_NEW_ENTRIES = [
  {
    ...
    summary: 'Evidensetiketter som Bekräftad/Tjänstetypisk/Saknad information läggs inte längre in sist i sårbarhetsbeskrivningen. De syns inte i UI och rensas bort om AI ändå läcker dem.'
  },
  {
    date: '2026-09-03',
    importance: 2,
