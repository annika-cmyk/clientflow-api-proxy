...
const WHATS_NEW_ENTRIES = [
  {
    date: '2026-08-28',
    importance: 4,
    title: 'Skapa uppdragsåtgärd från kundspecifika åtgärder',
    summary: 'När en kundspecifik åtgärd är markerad «Görs inte» kan du koppla den till uppdrag. Finns uppdraget redan läggs åtgärden på körningen; annars öppnas samma skapa-uppdrag-popup som på Uppdrag-fliken.'
  },
  {
    date: '2026-08-28',
    importance: 2,
