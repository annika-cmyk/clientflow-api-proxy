...
const WHATS_NEW_ENTRIES = [
  {
    ...
    summary: 'När AI analyserar en tjänst ligger kommentarer och förslag på Översikt, Hot, Sårbarheter och Åtgärder — inte i en lång lista. Ändringar i befintlig text markeras. Källor visar undersida och sökväg, inte bara startsidan.'
  },
  {
    date: '2026-08-21',
    importance: 5,
