...
const WHATS_NEW_ENTRIES = [
  ...
  {
    date: '2026-09-16',
    title: 'Eget uppdrag skapar körning även utan Airtable-val',
    summary:
      'När Typ «Eget uppdrag» saknas i Uppdragskörningar skapas körningen ändå (via typecast eller utan typfältet), så engångsuppdrag syns i kalender och aktuella körningar.',
    importance: 5,
  },
  {
    date: '2026-09-16',
    title: 'Mejl: starta uppgift från kopplingsmålet',
    summary:
      'Under Koppla mejl / bilagor kan du välja Uppgift (som från anteckningar). Den skapas i Mina uppgifter och som engångsuppdrag så du kan lägga tid i kalendern.',
    importance: 5,
  },
  {
    date: '2026-09-16',
