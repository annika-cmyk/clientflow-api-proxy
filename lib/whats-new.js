...
const WHATS_NEW_ENTRIES = [
  {
    ...
    summary: 'Kundformuläret har tjänster (byråns val), förväntad omfattning, VH-bekräftelse Ja/Osäker/Nej, separat ombud, villkorade kontrollfrågor per tjänst och källbadge per fält. Neutral faktayta utan riskpoäng.'
  },
  {
    date: '2026-09-12',
    importance: 5,
