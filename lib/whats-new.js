...
const WHATS_NEW_ENTRIES = [
  {
    ...
    summary: 'Hemvist (byråns kunder) och motparter (kundens kunder & leverantörer) är nu två skilda Typ av riskfaktor. De visas under Vem är kunden? respektive Vad gör kunden?, och befintliga mallar migreras automatiskt.'
  },
  {
    date: '2026-08-28',
    importance: 2,
