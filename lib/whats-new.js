...
const WHATS_NEW_ENTRIES = [
  {
    date: '2026-09-16',
    importance: 2,
    title: 'Kalender: större yta utan hjälprad',
    summary:
      'Hjälptexten under filtren är borttagen så månads- och tidsrutnätet får mer plats — både högre celler och större vecka/dag-vy.'
  },
  {
    date: '2026-09-16',
    importance: 4,
  ...
  },
  {
    ...
    summary:
      'Planerade tidblock och bokade möten kan skickas till din Google-kalender via samma Gmail-koppling. Slå på Google under Kalender, koppla om Gmail om kalenderbehörighet saknas, och använd Synka för synliga block. Ändringar i ClientFlow uppdaterar samma Google-händelse (inga dubbletter).'
  },
  {
    date: '2026-09-16',
    importance: 4,
