...
const WHATS_NEW_ENTRIES = [
  {
    ...
    summary: 'På riskfaktorer, tjänster och Vilka är våra kunder syns risknivå som färgad vänsterkant, Förhöjd i amber (inte blått), Ta bort bakom …-menyn, och tjänster har unika ikoner. Listorna sorteras med högst risk först.'
  },
  {
    date: '2026-09-12',
    importance: 5,
    title: 'Full tjänstöversikt utan att redigera',
    summary: 'När ni fäller ut Visa översikt på ett tjänstkort visas nu all info: risknivåer och motiveringar, tjänstebeskrivning, hot, sårbarheter, åtgärder och alla utförandesvar — utan avklippning.'
  },
  {
    date: '2026-09-12',
    importance: 5,
    title: 'Fällbar översikt på tjänstekorten',
    summary: 'På Vilka tjänster erbjuder ni? kan ni klicka Visa översikt på ett kort för att se riskmotivering och utförandesvar utan att öppna Redigera.'
  },
  {
    date: '2026-09-12',
    importance: 5,
  ...
  },
  {
    date: '2026-09-12',
    importance: 3,
    title: 'Egna källor i Byråns resa',
  ...
  },
  {
    date: '2026-09-12',
    importance: 3,
    title: 'Tätare källkatalog i Byråns resa',
  ...
  },
  {
    date: '2026-09-12',
    importance: 5,
    title: 'Byråns resa – ny primär väg',
    summary: 'Under Riskbedömning finns Byråns resa: åtta steg som pekar in i befintliga sidor, plus en källkatalog (tagit del / använder / inte relevant) som måste fyllas innan slutgodkännande. Byrårutiner har fått egen rubrik för behandling av personuppgifter.'
  },
  {
    date: '2026-09-12',
    importance: 4,
