...
const WHATS_NEW_ENTRIES = [
  {
    date: '2026-08-27',
    importance: 2,
    title: 'Risksänkande faktorer – samma radlayout',
    summary: 'På Kundrisker mm ligger kundantalet efter faktornamnet och raden följer samma mönster som varningsflaggorna: namn, förklaring, källa och ta bort. Ny rad kan fyllas i med alla tre fält direkt.'
  },
  {
    date: '2026-08-27',
    importance: 2,
