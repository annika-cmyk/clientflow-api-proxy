...
const WHATS_NEW_ENTRIES = [
  {
    date: '2026-08-21',
    importance: 5,
    title: 'Kundkortet visar inneboende och residual för tjänster och riskfaktorer',
    summary: 'På kundens riskbedömning syns samma S×K-nivåer som på byråns sidor — inte det gamla enskilda Riskbedömning-värdet.'
  },
  {
    date: '2026-08-21',
    importance: 4,
    title: 'Tydligare vägledning för tjänster och övriga riskfaktorer',
    summary: 'På sidorna för byråns tjänster och övriga riskfaktorer förklaras nu skillnaden mellan penningtvätt och terrorfinansiering, och att inneboende risk och residualrisk ska hållas isär.'
  },
  {
    date: '2026-08-21',
    importance: 5,
