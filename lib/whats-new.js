...
const WHATS_NEW_ENTRIES = [
  {
    date: '2026-09-23',
    importance: 4,
    title: 'Årsvisa uppdrag: rätt start och deadline nästa år',
    summary:
      'När ett årsvis uppdrag har start 1 okt och deadline 31 mars behålls samma fönster första året. Nästa körning blir start och deadline ett år senare (t.ex. 2026-10-01 → 2027-03-31). Bokslut och deklaration får Årsvis som förvald frekvens.'
  },
  {
    date: '2026-09-22',
    importance: 5,
    title: 'Deploy: Render bootar igen efter mejl-merge',
    summary:
      'En mejl-merge lämnade kvar konfliktmarkörer i senaste-ändringar-listan, vilket gav SyntaxError vid uppstart och failade Render-deploy. Markörerna är borta och ett regressionstest stoppar samma fel framöver.'
  },
  {
    date: '2026-09-22',
    importance: 5,
    title: 'Mejl: sparar senaste månaden i Airtable',
    summary:
      'Inkorgen hämtar bara mejl som är högst 30 dagar gamla. Metadata och brödtext sparas i Airtable (Gmail Mejlcache), så listan och öppnade mejl visas från cache utan att hämta om från Gmail varje gång. Synken letar bara efter nya/ändrade inom fönstret. Även utan Gmail-koppling kan sparade mejl från den senaste månaden öppnas.'
  },
  {
    date: '2026-09-22',
    importance: 4,
    title: 'Mejl: sidfot före citat vid svar',
    summary:
      'När du svarar på ett mejl hamnar sidfoten direkt efter din text, ovanför det citerade originalet. Före citatet läggs en Gmail-lik rad på svenska: «Den fre 4 sep. 2026 kl 11:18 skrev Namn <epost>:». Nya mejl har sidfoten sist som tidigare.'
  },
  {
    date: '2026-09-22',
    importance: 4,
    title: 'Mejl: bilagor syns i listan',
    summary:
      'I mejlsammanfattningen visas en gem-ikon när mejlet har bilagor. Har det flera filer visas även antalet. Ikonen uppdateras när du öppnar mejlet eller synkar inkorgen.'
  },
  {
    date: '2026-09-22',
    importance: 5,
    title: 'Mejl: koppla till befintlig uppgift',
    summary:
      'I Koppla mejl / bilagor finns nu Befintlig uppgift under Kopplingsmål. Där väljer du bland kundens öppna Att göra-uppgifter. Länken till mejlet sparas på uppgiften (syns under Mina uppgifter), och mejl/bilagor kan samtidigt sparas i kunddokumentationen.'
  },
  {
    date: '2026-09-22',
    importance: 5,
    title: 'Mejl: åäö i ämnesraden när du skickar',
    summary:
      'När du skickar mejl från appen kodas ämnesraden korrekt (RFC 2047), så svenska tecken som å, ä och ö visas rätt hos mottagaren i stället för konstiga tecken.'
  },
  {
    date: '2026-09-19',
    importance: 5,
    title: 'Mejl: skapa uppdrag och uppgift i kopplingsmenyn',
    summary:
      'I Koppla mejl / bilagor väljer du Nytt uppdrag eller Ny uppgift direkt under Kopplingsmål. Då visas bara fälten som behövs (namn, handläggare, deadline), och mejlet kopplas till det som skapas. Dokumentation, Uppdragskörning och Uppdrag fungerar som förut.'
  },
  {
    date: '2026-09-19',
    importance: 4,
    title: 'Mejl: länk följer med tid och uppgift',
    summary:
      'När du reggar tid eller skapar en uppgift från ett mejl sparas en länk tillbaka till mejlet. Ämne och datum ligger kvar på tidpostens egna fält (beskrivning och datum). Länken syns i Tid, på uppgiften och under Mina uppgifter.'
  },
  {
    date: '2026-09-19',
    importance: 4,
    title: 'Mejl: regga tid direkt på mejlet',
    summary:
      'I mejldetaljen finns knappen Regga tid, bredvid Svara. Kund (om mejlet är matchat), ämne och dagens datum är ifyllda. Ange timmar och minuter, välj uppdrag om du vill, och spara. Posten hamnar i Tid som vanligt. Saknas kundmatch måste du välja kund först.'
  },
  {
    date: '2026-09-17',
    importance: 4,
    title: 'Kalender: klarmarkera utan tid',
    summary:
      'I körningens detaljpanel kan du välja Klarmarkera utan att registrera tid, eller Klarmarkera & registrera tid när tid är avsatt.'
  },
  {
    date: '2026-09-17',
    importance: 3,
    title: 'Kalender: Deadlines visar bara ej klara',
    summary:
      'Sidopanelen Deadlines/Öppna listar bara körningar som inte är klarmarkerade. Klara syns kvar i kalenderrutnätet när Klara-filtret är på.'
  },
  {
    date: '2026-09-17',
    importance: 5,
    title: 'AI riskfaktor: mindre modellvägran vid PT/TF-frågor',
    summary:
      'När Extra underlag frågar hur PT/TF kan gå till i en bransch (t.ex. smycken) tolkas det som lagstadgad PVML-dokumentation. Vid modellvägran görs ett mjukare omförsök i stället för att hela analysen failar.'
  },
  {
    date: '2026-09-17',
    importance: 5,
    title: 'Mejl: omatchade KUNDER-etiketter syns igen',
    summary:
      'Mejl under KUNDER som saknar kundmatch döljs inte längre. De visas med märket «Ingen kundmatch» (etikettnamnet som rubrik) så du kan öppna och koppla rätt kund. Filtret heter nu «Alla under KUNDER», med val «Omatchade etiketter». Synken samplar också per etikett så en aktiv kund inte tränger bort övriga.'
  },
  {
    date: '2026-09-17',
    importance: 3,
    title: 'Mejl-sidfot: all text är svart',
    summary:
      'I mejl-sidfoten (förhandsvisning och utskick) är namn, etiketter, adress och länkar nu svarta i alla dispositionsmallar. Logotypbilden behåller sina egna färger.'
  },
  {
    date: '2026-09-17',
    importance: 4,
    title: 'AI riskfaktor: reparering kraschar inte vid modellvägran',
    summary:
      'Om kvalitetsreparationen svarar med text i stället för JSON (t.ex. «I\'m sorry…») behålls det första giltiga AI-svaret i stället för att hela analysen failar. Repair-prompten är också mjukare formulerad som legitim PVML-dokumentation.'
  },
  {
    date: '2026-09-17',
    importance: 4,
    title: 'Mejl: skriv nytt mejl i högerkolumnen',
    summary:
      'När du klickar Nytt mejl (eller Svara) öppnas skrivformuläret i mejldetaljen till höger. Listan till vänster och statusraden ovanför är kvar, så du slipper lämna inkorgen. Avbryt eller skicka återställer detaljvyn.'
  },
  {
    date: '2026-09-17',
    importance: 3,
    title: 'Mejl: tydligare text när Gmail behöver kopplas igen',
    summary:
      'När Gmail-åtkomsten gått ut (t.ex. utgången token) förklarar Mejl tydligare att du behöver klicka Koppla Gmail och ge åtkomst igen — det är normalt och beror inte på en deploy som raderat kopplingen.'
  },
  {
    date: '2026-09-16',
    importance: 5,
    title: 'AI riskfaktor: bättre källor och reparering',
    summary:
      'Övriga riskfaktorer hämtar nu källutdrag via server-sökning i vector store (inte modellens egen file_search-query). Underkända svar repareras utan att återanvända gammalt generiskt innehåll, med skarpare krav på TF, källor och extra underlag.'
  },
  {
    date: '2026-09-16',
    importance: 5,
    title: 'Deploy: Mejl startar igen efter sidfot-fix',
    summary:
      'Ett syntaxfel i Gmail-API (kvarlämnad klammer efter flytt av MIME-byggaren) gjorde att Render-deploy kraschade vid uppstart. Det är åtgärdat så appen bootar igen.'
  },
  {
    date: '2026-09-16',
    importance: 5,
    title: 'Mejl: Koppla till uppdragskörning fungerar igen',
    summary:
      '«Koppla hela mejlet» till Uppdragskörning/Dokumentation kraschade p.g.a. fel MIME-typ (charset) mot Airtable. Det är åtgärdat, och dialogrutan är förenklad: vanliga valet är mejl + mål, medan skapa engångsuppdrag/uppgift ligger under Fler alternativ.'
  },
  {
    date: '2026-09-16',
    importance: 5,
    title: 'Mejl: sidfot syns hos mottagaren',
    summary:
      'Personlig mejl-sidfot (text och uppladdade bilder) följer nu med korrekt vid skicka via Gmail. Bilder skickas som inline-bilagor (inte data-URL som Gmail ofta tar bort), och du ser i utkastet om sidfoten är aktiv.'
  },
  {
    date: '2026-09-16',
    importance: 5,
    title: 'AI riskfaktor: mindre generisk AML-text',
    summary:
      'Övriga riskfaktorer får hårdare AI-regler och en kvalitetskontroll som underkänner svar med «vid varje transaktion», vaga källor, Båda utan TF-förklaring eller extra underlag som bara nämns ytligt. Underkända svar repareras i ett andra anrop.'
  },
  {
    date: '2026-09-16',
    importance: 4,
    title: 'AI-prompt-blobb: se exakt prompt och råsvar',
    summary:
      'Efter AI-analys på riskfaktorer och tjänster öppnas en egen AI-prompt-ruta (nedtill till vänster) där ni kan förstora och läsa instructions, prompt och rå JSON — samma vy fungerar även från Chatta med AI.'
  },
  {
    date: '2026-09-16',
    importance: 2,
    title: 'Chatta med AI: större chattruta',
    summary:
      'Chattrutan för ClientFlow AI är nu betydligt bredare och högre så att konversationen — och prompt/råsvar — får mer plats att läsa.'
  },
  {
    date: '2026-09-16',
    importance: 3,
    title: 'AI-analys: lägre tokenkostnad via prompt-cache',
    summary:
      'Riskfaktor- och tjänstanalys skickar nu stora, återanvändbara AI-regler som stabila instruktioner (med prompt-cache) i stället för att blanda in dem i varje variabelt användarmeddelande. API-svaren anger också vilken modell som användes (standard gpt-4o).'
  },
  {
    date: '2026-09-16',
    importance: 3,
    title: 'Chatta med AI: visa prompt och råsvar',
    summary:
      'Under varje AI-svar i Chatta med AI kan du öppna «Visa prompt / råsvar» och se exakt instructions, prompt och rå JSON som skickades till respektive kom från modellen.'
  },
  {
    date: '2026-09-16',
    importance: 4,
    title: 'AI omprövar alltid hot och sårbarheter',
    summary:
      'När ni genererar om AI-analys på riskfaktorer och tjänster ska hot/modus och sårbarheter alltid omprövas i samma svar — inte hoppas över bara för att beskrivning eller åtgärd redan finns. Tunna listor eller Extra underlag som saknas i sektionerna lyfts som jämförbara förslag.'
  },
  {
    date: '2026-09-16',
    importance: 4,
    title: 'AI-åtgärder: proportionerliga kontroller',
    summary:
      'AI ska inte längre föreslå att klientansvarig granskar alla transaktioner (t.ex. «över 1000 kr»). Förslagen ska vara riskbaserade stickprov med fokus på avvikelser, och bara använda trösklar som ni faktiskt angett.'
  },
  {
    date: '2026-09-16',
    importance: 4,
    title: 'Kalender: större yta för rutnätet',
    summary:
      'Sök klient ligger nu på samma rad som Mina/Byrån-filtren. Deadlines-listan ligger under kalendern så vecko- och dagsvyn får full bredd och mer höjd.'
  },
  {
    date: '2026-09-16',
    importance: 4,
    title: 'Kalender: Google-färger syns i appen',
    summary:
      'Händelser från Google Calendar behåller sina färger (eventfärg eller kalenderfärg) i ClientFlow-kalendern. Uppdragskörningarnas statusfärger (Klar m.m.) påverkas inte.'
  },
  {
    date: '2026-09-16',
    importance: 5,
    title: 'AI-analys: längre «AML för dummies»-texter',
    summary:
      'AI-förslag för riskfaktorer och tjänster ska nu skriva rikare förklaringar i klarspråk — inklusive vilka kontroller som görs, vem som gör dem och var de dokumenteras — i stället för korta Capego-meningar.'
  },
  {
    date: '2026-09-16',
    importance: 3,
    title: 'Kalender: markering för aktuell tid',
    summary:
      'I vecko- och dagsvy syns en röd «nu»-linje med punkt i dagens kolumn (som i Google Kalender). Markeringen följer klockan inom rutnätet 07–20.'
  },
  {
    date: '2026-09-16',
    importance: 3,
    title: 'Din resa: klarmarkera via cirkeln',
    summary:
      'I analyskortens sidosteg (Din resa) kan du klarmarkera ett steg genom att klicka på cirkeln/blobben — samma sparade klarmarkering som knappen Klarmarkera. Klick på textetiketten byter fortfarande steg.'
  },
  {
    date: '2026-09-16',
    importance: 5,
    title: 'Mejl → uppgift: status och svar från kalender',
    summary:
      'När du skapar en uppgift från ett mejl får mejlet statusen Uppgift skapad. Klarmarkerar du uppgiften i kalendern blir mejlet Hanterat, och du får frågan om du vill svara kunden — ja tar dig till mejlet i ClientFlow-inkorgen med svar-formuläret öppet.'
  },
  {
    date: '2026-09-16',
    importance: 3,
    title: 'Kalender: Deadlines utan Google-händelser',
    summary:
      'Sidopanelen Deadlines/Öppna visar bara ClientFlow-uppdragskörningar. Google-kalenderhändelser syns kvar i själva kalenderrutnätet när pull är aktiv.'
  },
  {
    date: '2026-09-16',
    importance: 3,
    title: 'Kalender: öppna kundkort via företagsnamn',
    summary:
      'I kalenderns körningsdetalj är företagsnamnet en länk till kundkortet. Knappen «Öppna kundkort» är borttagen.'
  },
  {
    date: '2026-09-16',
    importance: 4,
    title: 'Tid: markera flera som fakturerad + timpris från prislista',
    summary:
      'På Tid-sidan kan du kryssa i flera Klar-poster och markera dem som fakturerad i ett steg. Timpris hämtas automatiskt från byråns prislista (timtaxa) när det saknas — matchar aktivitet/uppdrag, annars default timpris eller enda gemensamma timpriset.'
  },
  {
    date: '2026-09-16',
    importance: 4,
    title: 'Kalender: tydligare lucka mellan tidblock',
    summary:
      'I vecko- och dagsvy har tidblocken en synlig lucka och tydligare kant så back-to-back-händelser (t.ex. Google-kalender) inte smälter ihop till en grå yta.'
  },
  {
    date: '2026-09-16',
    importance: 4,
    title: 'Kalender: klarmarkerade tider syns kvar',
    summary:
      'Efter Klarmarkera & registrera tid försvinner inte tidblocket från kalendern. Både Ej klara och Klara visas som standard (grön Klar-stil), och i Öppna-läge syns klarmarkerade körningar med planerad tid eller deadline i perioden.'
  },
  {
    date: '2026-09-16',
    importance: 4,
    title: 'Kalender: Google-händelser utan knapprad',
    summary:
      'Google-händelser hämtas automatiskt in i kalendern när Gmail är kopplad (med kalenderbehörighet). Knapparna Google/på-av/Koppla/Synka är borttagna från filterraden — koppla Gmail under Mejl om du vill se Google-händelser.'
  },
  {
    date: '2026-09-16',
    importance: 5,
    title: 'Extra underlag skriver om AI-analysen på riktigt',
    summary:
      'När ni fyller i Extra underlag och genererar om AI-analysen skrivs «Hur hanteras risken?» och residualmotivering om utifrån era fakta (pris, kanaler, geografi m.m.) — inte samma Capego-text med ett ord tillagt. Gäller både riskfaktorer/kundrisker och byråns tjänster.'
  },
  {
    date: '2026-09-16',
    importance: 5,
    title: 'Riskfaktor: redigera och kundräknare fungerar igen',
    summary:
      'Redigera-knappen på riskfaktorkort kraschade efter den gemensamma analyskort-mallen (saknat post-id). Det är åtgärdat. Kundräknaren på högriskbransch-kort (t.ex. Smycken/antikviteter) räknar nu kunder utifrån branschetiketten, inte bara direktlänkade risk-id:n.'
  },
  {
    date: '2026-09-16',
    importance: 5,
    title: 'Kalender: händelser från Google',
    summary:
      'När Gmail är kopplad med kalenderbehörighet hämtas dina Google-händelser in i ClientFlow-kalendern (månad/vecka/dag). De märks som Google så de skiljs från uppdragskörningar — utan dubbletter av det ClientFlow redan pushat.'
  },
  {
    date: '2026-09-16',
    importance: 3,
    title: 'Kalender: renare topp och större yta',
    summary:
      'Knappaden Google/Koppla/Synka/Möten/Tid/Uppdragstavla är borttagen från kalendern (sidomenyn finns kvar). Hjälptexten under filtren är också borta så rutnätet får mer plats.'
  },
  {
    date: '2026-09-16',
    importance: 4,
    title: 'Samma analyskort-mall för tjänst och riskfaktorer',
    summary:
      'Analyskorten (lista och Din resa-modal) byggs nu från en gemensam mall. Ändringar i mallen gäller både Byråns tjänster och övriga riskfaktorer / Vilka är våra kunder — ni behöver inte underhålla varje typ separat.'
  },
  {
    date: '2026-09-16',
    importance: 5,
    title: 'AI riskfaktor: extra underlag vägs in skarpt',
    summary:
      'När ni fyller i Extra underlag till AI på övriga riskfaktorer och kundrisker används texten nu i analysen — särskilt i «Hur hanteras risken?» och motivering av residualrisk. Kundspecifika fakta (pris, andrahandsvärde, spårbara kanaler) ersätter generisk Capego-boilerplate, medan inneboende risk för högriskbransch hålls branschbaserad.'
  },
  {
    date: '2026-09-16',
    importance: 5,
    title: 'Kalender: synka till Google-kalender',
    summary:
      'Planerade tidblock och bokade möten kan skickas till din Google-kalender via samma Gmail-koppling. Koppla Gmail under Mejl (med kalenderbehörighet). När sync är på uppdaterar ändringar i ClientFlow samma Google-händelse (inga dubbletter).'
  },
  {
    date: '2026-09-16',
    importance: 4,
    title: 'Historik och track record är redigerbar i AR',
    summary:
      'Under Allmän riskbedömning byrå kan ni nu skriva och spara egen analys av historik och track record, samt generera AI-förslag utifrån byråquiz. Enkätsvaren syns kvar som underlagschips.'
  },
  {
    date: '2026-09-16',
    importance: 4,
    title: 'Byråquiz: fördelning av kundernas residualrisk',
    summary:
      'Under Kundstockens sammansättning kan ni ange hur många kunder som har låg, normal, förhöjd, hög respektive oacceptabel residualrisk. Svaret syns som chips under Från byråprofilen på Vilka är våra kunder, och kan fyllas i automatiskt från Clientflow.'
  },
  {
    date: '2026-09-16',
    importance: 5,
    title: 'Byråquiz: högrisktjänster blir förslag på Byråns tjänster',
    summary:
      'Svar om betalningsuppdrag, bolagsbildning, nominee, säte/postadress och känsliga fullmakter visas som tjänstekort-förslag under Från byråprofilen på Byråns tjänster. Nej döljer förslaget — samma filter som övriga riskförslag.'
  },
  {
    date: '2026-09-16',
    importance: 5,
    title: 'Kalender: klarmarkera och registrera tid i ett steg',
    summary:
      'I körningens detaljpanel kan du klarmarkera och registrera den avsatta tiden direkt — utan att hoppa till tid-sidan. Körningen blir Klar och tiden sparas som registrerad.',
  },
  {
    date: '2026-09-16',
    importance: 5,
    title: 'Byråquiz: svar styr vilka analyser som föreslås',
    summary:
      'Svaren i byråprofil-enkäten kopplas till rätt analyssida och filtrerar förslagen. Betalningsuppdrag och högrisktjänster landar på Byråns tjänster; beroenden, near misses och outsourcing styr Övriga riskfaktorer.'
  },
  {
    date: '2026-09-16',
    importance: 4,
    title: 'Byråquiz kopplad till rätt analyssidor',
    summary:
      'I byråprofil-enkäten syns nu tydliga länkar från interna profilen till Verksamhetsspecifika riskfaktorer, från Kundstockens sammansättning till Vilka är våra kunder, och från Distributionskanaler till motsvarande sektion på Övriga riskfaktorer. På Övriga kan ni också hoppa tillbaka till rätt enkätsteg.'
  },
  {
    date: '2026-09-16',
    title: 'Kalender: växla mellan Deadline och Öppna',
    summary:
      'I kalendern kan du välja Öppna för att se körningar som går att göra nu i perioden — även om deadlinen ligger senare. Deadline-läget fungerar som tidigare.',
    importance: 4,
  },
  {
    date: '2026-09-15',
    title: 'Kundformulär: dolda fält när de inte behövs',
    summary:
      'Detaljer för PEP, närstående, kontanter, förklaring till villkorade frågor, TIN och länder visas bara när svaret är Ja (eller hemvist utanför Sverige). Formuläret tar mindre plats och är tydligare.',
    importance: 4,
  },
  {
    date: '2026-09-15',
    title: 'Kalender: avsatt tid följer när du ändrar blocket',
    summary:
      'När du drar i nederkanten av ett tidblock uppdateras Avsatt tid och knappen Registrera tid i detaljpanelen direkt — samma längd som du markerat i kalendern.',
    importance: 4,
  },
  {
    date: '2026-09-15',
    title: 'Mejl: skapa enstaka uppdrag fungerar igen',
    summary:
      'När du kopplar mejl och skapar «Eget uppdrag» (t.ex. Lön) hanteras saknade Airtable-val bättre så skapandet inte fastnar på 422.',
    importance: 5,
  },
  {
    date: '2026-09-15',
    title: 'Kalender visar bara uppdragskörningar',
    summary:
      'I kalendern (månad/vecka/dag och deadlines-listan) syns nu enbart uppdragskörningar — inte föräldra-uppdrag. Det tar bort dubbletter som t.ex. både «Bokslut · 2026» och «Bokslut · 2026-09».',
    importance: 5,
  },
  {
    date: '2026-09-15',
    title: 'Kalender: dra tidblock till tidregistrering',
    summary:
      'I vecko- och dagsvy syns tider 07–20. Dra uppdragskörningar till rätt dag/tid och dra i nederkant för att blocka längd. Avsatt tid sparas på körningen och fylls i automatiskt när du registrerar tid.',
    importance: 5,
  },
  {
    date: '2026-09-15',
    title: 'Mejl: snabbmeny på varje mejl',
    summary:
      'Tre prickar på mejlkorten ger Att hantera, Hanterat, Radera (bara från ClientFlow-listan) och Koppla till uppdrag / skapa uppgift.',
    importance: 5,
  },
  {
    date: '2026-09-15',
    title: 'Mejl: bilageförhandsgranskning fungerar igen',
    summary:
      'Förhandsgranskning och nedladdning av mejlbilagor (t.ex. faktura-PDF) funkar igen när Gmail-id:n är långa eller MIME-strukturen är udda.',
    importance: 5,
  },
  {
    date: '2026-09-15',
    title: 'Mejl: klickbart kundnamn, endast öppna, dölj utan Gmail-radering',
    summary:
      'Klicka på företagsnamnet för att öppna kundkortet. Ny flik «Endast öppna» visar ohanerade mejl. Radera tar bort från ClientFlow-listan men inte från Gmail. Mejl till underlag@ visas inte i inkorgen.',
    importance: 5,
  },
  {
    date: '2026-09-15',
    title: 'Mejl: ingen Gmail-etikett i listan',
    summary:
      'Mejllistan visar inte längre Gmail-etiketten på varje kort — företagsnamnet i rubriken räcker.',
    importance: 3,
  },
  {
    date: '2026-09-15',
    title: 'Mejl: koppla bilagor och skapa enstaka uppdrag',
    summary:
      'Dialogen heter nu Koppla mejl/bilagor. Du kan skapa ett enstaka uppdrag (t.ex. en engångslön) direkt när du kopplar bilagor — utan att först gå via kundkortet.',
    importance: 5,
  },
  {
    date: '2026-09-15',
    title: 'Mejl: stabilare Gmail-synk',
    summary:
      'Inkorgssynken kraschade ibland med 500. Mejl-sidan laddas nu även om synken misslyckas, med tydligare fel och möjlighet att koppla Gmail igen.',
    importance: 4,
  },
  {
    date: '2026-09-15',
    title: 'Kalender: vecko- och dagsvy',
    summary: 'Byt mellan Månad, Vecka och Dag i uppdragskalendern. Navigering och deadlines följer vald vy, och valet sparas till nästa besök.',
    importance: 4,
  },
  {
    date: '2026-04-09',
    title: 'AI-analys fyller riskfaktorn',
    summary: 'Generera AI-analys fyller även hot, sårbarheter och synliga motiveringar – och hoppar till rätt steg så du ser resultatet direkt.',
    importance: 5,
  },
  {
    date: '2026-09-15',
    importance: 4,
    title: 'Kalendern visas för inloggade igen',
    summary:
      'Uppdragskalendern kunde felaktigt säga "Logga in för att visa kalendern" trots att du redan var inloggad. Den väntar nu tills inloggningen är klar innan den laddar.'
  },
  {
    date: '2026-09-15',
    importance: 5,
    title: 'Clientflow-statistik räknar bara pågående kunder',
    summary:
      'Bolagsformer, branscher, PEP och övriga Clientflow-siffror under Vilka är våra kunder och Statistik inkluderar bara kunder med status Pågående — avslutade, leads och dolda räknas inte. Analyspanelen använder samma live-siffror.'
  },
  {
    date: '2026-09-15',
    importance: 5,
    title: 'Tidregistrering som fakturaunderlag',
    summary:
      'Under Byrå → Tid registrerar ni arbetad tid per kund (timmar, beskrivning, valfritt timpris). Markera som Klar så blir posterna fakturaunderlag — klart för framtida fakturering.'
  },
  {
    date: '2026-09-15',
    importance: 4,
    title: 'Ändra byråquiz-svar direkt på kundsidan',
    summary:
      'På Vilka är våra kunder kan Ledare nu klicka Ändra på enkät-etiketter (t.ex. komplexa ägarstrukturer) och uppdatera svaret direkt — utan att gå omvägen via hela byråprofil-enkäten.'
  },
  {
    date: '2026-09-15',
    importance: 5,
    title: 'Mötesbokning med kundlänk',
    summary:
      'Under Byrå → Möten kan ni skapa tidsluckor och skicka en bokningslänk. Kunden väljer tid själv — utan inloggning.'
  },
  {
    date: '2026-09-15',
    importance: 5,
    title: 'Kunduppgifter i statistikformat — utan dubbletter',
    summary:
      'På Vilka är våra kunder visas nu alla enkät-svar om kundstocken som samma sektions-/chip-vy som Statistik för riskbedömning. Live-siffror från Clientflow används där det finns (klickbara), övriga enkät-svar som etiketter — utan att samma sak visas två gånger. Analysera/Avstå finns kvar.'
  },
  {
    date: '2026-09-15',
    importance: 5,
    title: 'Kalender för uppdragskörningar',
    summary:
      'Under Byrå finns nu Kalender — en månadsvy över uppdragskörningars deadlines. Filtrera på mina/byråns, typ och status, och öppna kundkort direkt från en körning.'
  },
  {
    date: '2026-09-15',
    importance: 4,
    title: 'AML-kollen: kontoutdrag eller SIE räcker',
    summary:
      'Ni kan nu köra AML-kollen med antingen kontoutdrag eller SIE — båda behövs inte. Ladda upp båda när ni vill matcha bank mot bokföring; med en fil körs analysen på det underlag som finns.'
  },
  {
    date: '2026-09-15',
    importance: 4,
    title: 'Kundresa utan VH för enskild firma',
    summary:
      'För enskild firma och fysisk person visas inte längre steget Verifiera VH i kundresan. Övriga steg numreras om och progress räknas utan VH — samma regel som i kundformuläret.'
  },
  {
    date: '2026-09-15',
    importance: 4,
    title: 'Förhandsgranska uppdragsavtal innan signering',
    summary:
      'På kundkortets uppdragsavtal finns nu knappen Förhandsgranskning bredvid PDF och Skicka. Öppna dokumentet i en dialog och skicka till InLeed-signering direkt från förhandsgranskningen.'
  },
  {
    date: '2026-09-14',
    importance: 5,
    title: 'Mejl: Delat med mig utan Gmail',
    summary:
      'När någon delar ett mejl med dig syns det under Delat med mig på Mejl-sidan — även om du inte kopplat Gmail. Inkorg/Skickat kräver fortfarande Gmail; knappen «Öppnar Google…» fastnar inte längre om kopplingen avbryts.'
  },
  {
    date: '2026-09-14',
    importance: 5,
    title: 'Statistik: klickbara siffror och tydlig källa',
    summary:
      'Under Statistik för riskbedömning visas nu etiketter som klickbara chips (som under Från byråprofilen). Alla kategorier — risknivå, högriskbransch, utsatta områden, riskfaktorer m.m. — leder till kundlista. Badges visar om siffran kommer från Clientflow eller Byråprofil.'
  },
  {
    date: '2026-09-14',
    importance: 3,
    title: 'Tjänstekort: klicka för översikt',
    summary:
      'På Vilka tjänster erbjuder ni? öppnar ett klick på kortet översikten. Redigera och aktivera/inaktivera ligger i trepunktsmenyn, och strecket längst ner på kortet är borta.'
  },
  {
    date: '2026-09-14',
    importance: 4,
    title: 'Klickbara branscher på Vilka är våra kunder',
    summary:
      'Under Från byråprofilen på Vilka är våra kunder kan ni klicka på en bransch (t.ex. Bygg eller Fastighet) och borra ner till underbranscher och kundlistor — samma vy som under Statistik för riskbedömning. Analysera-knapparna fungerar som tidigare.'
  },
  {
    date: '2026-09-14',
    importance: 4,
    title: 'Klickbar branschstatistik med underbranscher',
    summary:
      'Under Statistik för riskbedömning kan ni klicka på en översiktsbransch (t.ex. Bygg och anläggning eller Fastighet) och borra ner till underbranscher och kundlistor. Högriskbranscher fungerar på samma sätt.'
  },
  {
    date: '2026-09-13',
    importance: 5,
    title: 'Byt namn på analyserad riskfaktor',
    summary:
      'Namnet på en analyserad riskfaktor sparas igen (det försvann tidigare vid Spara eftersom fältet låg utanför formuläret). Saknas namn visas «Namnlös riskfaktor» i listan — byt via …-menyn eller Redigera, skriv namnet överst i modalen och spara.'
  },
  {
    date: '2026-09-13',
    importance: 5,
    title: 'Riskfaktor: Beskrivning och namn sparas',
    summary:
      'I analysmodalen för övriga riskfaktorer och Vilka är våra kunder sparas nu Beskrivning och riskfaktorns namn korrekt (namnfältet låg utanför formuläret). Ni kan spara översikten utan att först fylla Riskreducerande åtgärder. Hjälptexten om att undvika «byrån»/kontroller blockerar inte sparning.'
  },
  {
    date: '2026-09-13',
    importance: 3,
    title: 'Egna alternativ i byråprofil-enkäten',
    summary:
      'På flervalsfrågorna (pill-valen) i byråprofilen kan ni lägga till egna alternativ via «+ Eget alternativ». Under kundens ursprung finns också «Rekommendation via befintliga kunder» och «Via personligt nätverkande».'
  },
  {
    date: '2026-09-13',
    importance: 5,
    title: 'Sparade mejl på uppdragskörning är läsbara',
    summary:
      'När du sparar hela mejlet till Uppdragskörning/Dokumentation sparas det som en tydlig HTML-vy (ämne, från, till, datum och brödtext). Äldre .txt-dumpar öppnas också i samma läsbara layout i förhandsvisningen.'
  },
  {
    date: '2026-09-13',
    importance: 4,
    title: 'Byråprofilen sparas trots äldre Leveranssätt-val',
    summary:
      'Enkäten och byråprofilen blockeras inte längre när Airtable saknar de nya Leveranssätt-valen. Värdet mappas till Distans/På plats/Blandat när det behövs, så övriga uppgifter (t.ex. kundstock) sparas som vanligt.'
  },
  {
    date: '2026-09-13',
    importance: 2,
    title: 'Årsredovisning: färre utförandefrågor',
    summary:
      'Frågan «Upprättar byrån årsredovisningen?» är borttagen från utförandemallen för årsredovisning. Övriga frågor, inklusive inlämning till Bolagsverket, finns kvar.'
  },
  {
    date: '2026-09-13',
    importance: 4,
