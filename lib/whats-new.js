...
const WHATS_NEW_ENTRIES = [
  {
    date: '2026-08-28',
    importance: 2,
    title: 'Gemensam redigering för kundbeskrivning',
    summary: 'Under «Beskrivning av kunden» redigeras Verksamhet, Kostnader, Intäkterna och Bokföring med en gemensam penna och Spara-knapp i stället för en penna per block.'
  },
  {
    date: '2026-08-28',
    importance: 2,
