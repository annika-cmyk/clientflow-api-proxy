...
const WHATS_NEW_ENTRIES = [
  {
    date: '2026-08-28',
    importance: 4,
    title: 'Geografi för kunder/leverantörer under Vad gör kunden?',
    summary: 'Riskfaktorer om var kundens kunder och leverantörer finns ligger nu under Vad gör kunden? — separat från hemvist under Vem är kunden?. PDF:en använder samma uppdelning.'
  },
  {
    date: '2026-08-28',
    importance: 2,
