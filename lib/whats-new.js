...
const WHATS_NEW_ENTRIES = [
  {
    date: '2026-09-13',
    importance: 4,
    title: 'Mejl: skapa uppdrag eller uppgift med deadline',
    summary:
      'Från mejldetaljen kan du skapa en ny uppgift (som Att göra i anteckningar) eller ett eget engångsuppdrag, med titel, deadline och förifylld text från mejlet.'
  },
  {
    date: '2026-09-13',
    importance: 3,
