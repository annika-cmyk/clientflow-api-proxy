...
const WHATS_NEW_ENTRIES = [
  {
    ...
    summary: 'Kryssen under Riskhöjande faktorer övrigt räknas in i beräknad residual. Allvarliga taggar sätter golv Hög, två samverkande taggar likaså. Kortvarig affärsrelation är utbytt mot många byten av redovisningsbyråer.'
  },
  {
    date: '2026-08-21',
    importance: 5,
