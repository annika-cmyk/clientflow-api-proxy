...
const WHATS_NEW_ENTRIES = [
  {
    date: '2026-09-13',
    importance: 5,
    title: 'Mejl-inkorg: bara KUNDER, rätt sortering och tydligare rubriker',
    summary: 'Inkorgen hämtar endast mejl under etiketten KUNDER (och underetiketter), sorterar nyast först och visar kundföretag + avsändare som huvudrubrik med ämnet under. E-post används bara för att koppla kund bland redan KUNDER-filtrerade mejl.'
  },
  {
    date: '2026-09-13',
    importance: 5,
