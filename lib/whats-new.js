...
const WHATS_NEW_ENTRIES = [
  {
    ...
    summary: 'I KYC under Internationell handel väljer ni länder i stället för fritext. Varje land jämförs mot EU:s förteckning över högriskländer. Träffen syns också under Geografiska riskfaktorer.'
  },
  {
    date: '2026-08-24',
    importance: 4,
  ...
  },
  {
    ...
    summary: 'A. Hur samarbetar vi?, B. Vem är kunden? och C. Vad gör kunden? innehåller nu både byråns vanliga riskfaktorer och kompletterande varningsflaggor. Geografiska riskfaktorer ligger kvar som eget kort.'
  },
  {
    date: '2026-08-24',
    importance: 3,
