...
const WHATS_NEW_ENTRIES = [
  {
    ...
    summary: 'På varje person under Roller kan du ange när och hur identiteten kontrollerats (BankID, fysiskt möte, före ClientFlow m.m.). Visas som «Identitet kontrollerad [datum] via [metod]».'
  },
  {
    date: '2026-08-28',
    importance: 5,
