...
<<<<<<< HEAD
    importance: 3,
    title: 'Tydligare NRA-frågor i AML-profilen',
    summary: 'Checklistan för nationell riskbedömning har ny intro och sex frågor med konkreta exempel, så ni kan svara utifrån er faktiska kundkrets utan att slå upp termer.'
=======
    importance: 5,
    title: 'Kundresa med VH-gate och automatiska påminnelser',
    summary: 'På kundkortet syns en sexstegs kundresa (Bolagsverket → VH → screening → kundformulär → riskprofil → godkännande). Osäker/Nej på VH blockerar vidare steg, kundlänk och KYC-synk. Skickade kundformulär får automatiska påminnelsemejl, och ni kan synka svar till KYC-utkast utan full merge.'
>>>>>>> cursor/overnight-non-bankid-4cff
  },
  {
    date: '2026-09-13',
    importance: 4,
  ...
  },
  {
    ...
    summary: 'På tjänster och övriga riskfaktorer motiverar ni S och K var för dig. Tidigare fritext sparas som legacy och kan föreslås uppdelad när ni redigerar en post.'
  },
  {
    date: '2026-09-12',
    importance: 4,
    title: 'Riskfaktorkatalog får versionsnummer',
    summary: 'När ni ändrar övriga riskfaktorer räknas katalogversionen upp. Kundakter stämplas med versionen de bedömdes mot, och versionen visas under Driven av byråprofil.'
  },
  {
    date: '2026-09-12',
    importance: 4,
