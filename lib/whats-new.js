...
const WHATS_NEW_ENTRIES = [
  {
    ...
    summary: 'Kundkort och övriga sidor laddar typsnitt och skript mer effektivt, och kunddatan hämtas tidigare utan onödiga väntor — så att innehållet syns fortare.'
  },
  {
    date: '2026-08-27',
    importance: 4,
  ...
  },
  {
    date: '2026-08-27',
    importance: 5,
    title: 'Riskfaktorer syns igen under A–C',
    summary: 'Äldre riskfaktorer utan ikryssad «Aktuell» försvann från listorna under Hur samarbetar vi? och Vad gör kunden?. De visas nu igen — bara riskfaktorer som byrån uttryckligen inaktiverat hålls dolda.'
  },
  {
    date: '2026-08-27',
    importance: 5,
    title: 'Riskfaktorer går att välja i KYC igen',
    summary: 'Under Hur samarbetar vi? och Vad gör kunden? syntes bara «Inga riskfaktorer» utan byråns övriga riskfaktorer att bocka i. Vid redigering visas nu hela listan igen — sparade val syns fortfarande som tidigare.'
  },
  {
    date: '2026-08-27',
    importance: 4,
  ...
  },
  {
    date: '2026-08-27',
    importance: 5,
    title: 'Riskfaktorer laddas igen på kundkortet',
    summary: 'Ett tekniskt fel gjorde att riskfaktorer under A–C på riskbedömningen visade «Kunde inte ladda risker». Det är åtgärdat — valda faktorer visas som tänkt.'
  },
  {
    date: '2026-08-27',
    importance: 4,
  ...
  },
  {
    date: '2026-08-27',
    importance: 5,
    title: 'Företagsinformation laddas igen på kundkortet',
    summary: 'En bugg gjorde att fliken Företagsinformation fastnade på «Laddar…» för kunder med adress. Det är åtgärdat — uppdatera sidan om du fortfarande ser spinnern.'
  },
  {
    date: '2026-08-27',
    importance: 2,
