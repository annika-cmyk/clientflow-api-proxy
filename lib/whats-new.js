...
const WHATS_NEW_ENTRIES = [
  {
    ...
    summary: 'Fäll ut tjänsten på kundkortet för att bocka av kundspecifika åtgärder och se både inneboende och residual. Ni kan korrigera S och K. Värdet följer med till kundens riskbedömning. Åtgärdsförslag hämtas från åtgärder kopplade till uppdragskörningar.'
  },
  {
    date: '2026-08-24',
    importance: 4,
  ...
  },
  {
    date: '2026-08-24',
    importance: 5,
    title: 'Varningsflaggor i riskkategorierna',
    summary: 'Övriga varningsflaggor ligger nu i korten Distributionskanaler, Riskfaktorer kopplat till kund och Verksamhetsspecifika. Distans, PEP och kontanter väljs som tidigare i samma kort – utan extra block under.'
  },
  {
    date: '2026-08-24',
    importance: 3,
