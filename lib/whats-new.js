...
const WHATS_NEW_ENTRIES = [
  {
    date: '2026-08-28',
    importance: 4,
    title: 'Skärpta åtgärder, dokumentera-krav och tydligare risk-PDF',
    summary: 'Vid «Fortsätter med skärpta åtgärder» kan du schemalägga engångsuppdrag (Uppdragsavgörande åtgärder) eller bara motivera. Dokumentera riskbedömning kräver att allt är ifyllt. PDF:en tar med alla riskfaktorsektioner inklusive «Inga …»-lägen samt riskaptitmotivering.'
  },
  {
    date: '2026-08-28',
    importance: 2,
  ...
  },
  {
    date: '2026-08-28',
    importance: 2,
    title: 'Tydligare geografirubrik på Kundrisker',
    summary: 'Rubriken för geografiska riskfaktorer på Kundrisker mm heter nu «Geografisk riskfaktorer - här finns kundens kunder & leverantörer».'
  },
  {
    date: '2026-08-27',
    importance: 3,
