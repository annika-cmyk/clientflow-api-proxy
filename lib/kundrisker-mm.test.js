...
describe('kundrisker-mm', () => {
  it('har egen sida med kundrisk, båda geo-spåren, varningsflaggor och risksänkande', () => {
    ...
    assert.match(html, /ovriga-riskfaktorer\.js\?v=50/);
    ...
    assert.match(html, /styles\.css\?v=20260915kundstat/);
    assert.match(html, /novalidate/);
    assert.match(html, /id="kundrisker-clientflow-statistik-section"/);
    assert.match(html, /id="kundrisker-clientflow-statistik-root"/);
    ...
    assert.match(html, /kundrisker-clientflow-statistik\.js\?v=1/);
    assert.match(html, /kundrisker-enkat-sammanfattning\.js\?v=7/);
    ...
    assert.match(ovriga, /styles\.css\?v=20260913namn/);
