...
describe('kundrisker-mm', () => {
  it('har egen sida med kundrisk, varningsflaggor och risksänkande', () => {
    ...
    assert.match(html, /Geografisk riskfaktorer - här finns kundens kunder & leverantörer/);
    assert.match(html, /value="Geografisk riskfaktorer - här finns kundens kunder & leverantörer">Geografisk riskfaktorer - här finns kundens kunder & leverantörer/);
    assert.match(html, /geo-risk-typer\.js\?v=1/);
    assert.match(html, /id="riskhoj-katalog-section"/);
    assert.match(html, /id="risksank-katalog-section"/);
    assert.match(html, /ovriga-riskfaktorer\.js\?v=37/);
    ...
    assert.match(ovriga, /geo-risk-typer\.js\?v=1/);
