...
describe('kundrisker-mm', () => {
  it('har egen sida med kundrisk, varningsflaggor och risksänkande', () => {
    ...
    assert.match(html, /value="Geografisk riskfaktorer - här finns byråns kunder">Geografisk riskfaktorer - här finns kundens kunder & leverantörer/);
    assert.match(html, /id="riskhoj-katalog-section"/);
    assert.match(html, /id="risksank-katalog-section"/);
    assert.match(html, /ovriga-riskfaktorer\.js\?v=36/);
