...
describe('feed (layer 3 + filter)', () => {
  ...
  it('behåller AI-sammanfattning skriven till byrån', () => {
    const feed = buildFirmFeed([{
      ...
      summary_sv: 'Det här rör främst den som vill tillbaka som revisor, inte er löpande redovisning. För byrån räcker det att veta var kraven finns.',
      raw_content: 'Här hittar du information om vad som gäller för den som tidigare har varit auktoriserad eller godkänd revisor och vill återkomma till yrket.',
      affected_industries: [],
      affected_geography: ['se']
    }], PROFIL, { minTier: 'low' });
