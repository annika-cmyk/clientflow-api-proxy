...
const ITEMS = [
  {
    ...
    source: 'eurlex',
    source_url: 'https://eur-lex.europa.eu/legal-content/EN/TXT/2026/09/03/high-risk',
  ...
  },
  {
    ...
    title: 'Allmänt tips',
    source: 'srf',
    source_url: 'https://www.srfkonsulterna.se/nyheter/allmant-tips/',
  ...
  },
  {
    ...
    source_url: 'https://www.lansstyrelsen.se/stockholm/om-oss/pressrum/nyheter/byggvagledning.html',
  ...
  it('visar bara riktiga nyheter publicerade från 1 september 2026', () => {
    ...
    const feed = buildFirmFeed([
      ...
      },
      {
        ...
        source: 'ekobrottsmyndigheten',
        source_url: 'https://www.ekobrottsmyndigheten.se/redovisningskonsult',
        published_at: '2026-09-01T08:00:00.000Z',
        fetched_at: '2026-09-01T10:00:00.000Z',
        summary_sv: 'Samarbete med FAR och SRF för att förebygga ekonomisk brottslighet.',
        category: 'rapporteringsrutiner',
        severity: 'kraver_atgard',
        affected_industries: [],
        affected_geography: ['se']
      },
      {
        ...
        source: 'ekobrottsmyndigheten',
        source_url: 'https://www.ekobrottsmyndigheten.se/penningtvattsbrott',
        published_at: '2026-09-01T08:00:00.000Z',
        summary_sv: 'Förklaring av vad penningtvätt är.',
        category: 'lagandring',
        severity: 'informativ',
        affected_industries: [],
        affected_geography: ['se']
      ...
      {
        id: 'sns-report',
        title: 'Penningtvätt och visselblåsare, på SNS webbplats (In English)',
        source: 'finanspolisen',
        source_url: 'https://www.sns.se/artiklar/money-laundering-and-whistleblowers/',
        published_at: '2026-09-01T08:00:00.000Z',
        summary_sv: 'Rapport från SNS om penningtvätt och visselblåsare.',
        category: 'lagandring',
        severity: 'informativ',
        affected_industries: [],
        affected_geography: ['se']
    ...
    assert.ok(!feed.some((i) => i.id === 'ebm-topic'));
    assert.ok(!feed.some((i) => i.id === 'ebm-glossary'));
    assert.ok(!feed.some((i) => i.id === 'sns-report'));
