...
describe('pipeline lager är oberoende', () => {
  ...
  it('classify hoppar över poster som isEligible nekar', async () => {
    const store = createMemoryStore([{
      id: 'old1',
      source: 'fatf',
      source_url: 'https://fatf/old',
      title: 'Old grey list',
      published_at: '2019-01-01T12:00:00.000Z',
      raw_content: 'Old content about monitoring',
    ...
    assert.equal(classify.attempted, 0);
  });
