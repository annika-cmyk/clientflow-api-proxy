...
TF — sidonot, inte spekulativt huvudhot:
- Prioritera de mest sannolika och relevanta AML-hoten: osanna fakturor, felaktiga underlag, överdrivna kostnader, oklara betalningar och legitimering av transaktioner.
- Undvik spekulativa terrorismfinansieringsscenarier om de inte stöds av konkreta riskfaktorer i underlaget. TF får nämnas försiktigt, inte som huvudhot.
...
- TF-täckning krävs fortfarande: minst ett TF- eller Båda-hot, eller en kort tfMotivering. Lämna inte luckan tom.
...
function analyzeUtforandeSignals(namn, state) {
  ...
  if (isRotRut) {
    ...
    lines.push('- Huvudhot: felaktiga eller överdrivna ROT/RUT-underlag som legitimerar kostnader, betalningar eller skattereduktioner. Inte spekulativ terrorismfinansiering.');
  } else {
...
Beskriv inte bara att tjänsten "kan utnyttjas". Förklara:
1. Vilken uppgift eller handling som kan vara felaktig.
2. Hur kunden eller annan aktör kan använda tjänsten.
3. Varför byråns medverkan kan ge legitimitet eller minska upptäcktsrisken.
4. Vilken typ av penningtvätts-/TF-risk detta kan skapa.

Undvik svepande eller spekulativa terrorismfinansieringsscenarier om det inte finns konkret stöd i byråns svar. Prioritera praktiska och relevanta modus för redovisningsbyråer, t.ex. osanna fakturor, felaktiga underlag, överdrivna kostnader, oklara betalningar, kapitaltillskott utan underlag, lån från privatpersoner och utlandsbetalningar.

För ROT-/RUT-administration ska hot/modus främst beskriva risker kopplade till:
- felaktiga eller överdrivna ROT-/RUT-ansökningar,
- osanna eller överdrivna fakturor,
- felaktig fördelning mellan arbetskostnad och material,
- oklara betalningar,
- att byråns hantering eller inlämning till Skatteverket kan ge uppgifterna ökad legitimitet.

Varje hot ska ha:
- kort titel
- konkret beskrivning på 2–4 meningar
- inga vaga formuleringar
- inga dramatiska påståenden utan förklaring

Dåligt: "Tjänsten kan utnyttjas för penningtvätt."
Dåligt TF-huvudhot: "Falska ROT/RUT-tjänster kan deklareras för att flytta pengar till organisationer som finansierar terrorism."
Bra PT-huvudhot: "Felaktiga eller överdrivna ROT/RUT-underlag kan användas för att legitimera kostnader, betalningar eller skattereduktioner. Byråns hantering eller inlämning till Skatteverket kan ge uppgifterna ökad legitimitet."`;
