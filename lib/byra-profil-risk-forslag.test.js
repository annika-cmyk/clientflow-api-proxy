...
describe('byra-profil-risk-forslag', () => {
  ...
  it('Ja på betalningsuppdrag ger förslag, Nej döljer det', () => {
    ...
    // Betalningsuppdrag föreslås som tjänstekort på Byråns tjänster, inte här.
  ...
  it('Ja/Delvis på högrisktjänster ger förslag, Nej döljer dem', () => {
    ...
    // Högrisktjänster flyttade till Byråns tjänster — kvar här: beroenden + historik.
  ...
  it('är inkopplat på övriga-sidan (inte kundrisker)', () => {
    ...
    assert.match(html, /byra-profil-risk-forslag\.js\?v=3/);
