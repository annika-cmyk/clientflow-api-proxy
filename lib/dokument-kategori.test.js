...
test('toDateOnly accepts ISO, compact and short year formats', () => {
  assert.equal(toDateOnly('2026-01-01'), '2026-01-01');
  assert.equal(toDateOnly('20260101'), '2026-01-01');
  assert.equal(toDateOnly('260101'), '2026-01-01');
  assert.equal(toDateOnly('2026-1-1'), '2026-01-01');
