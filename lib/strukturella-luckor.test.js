...
describe('strukturella-luckor', () => {
  it('samlar tjänsteavvikelser, saknad PT/TF och dimensionluckor', () => {
    const report = buildStrukturellaLuckor({
      ...
      tjanster: [
        { id: 'recBokslut01', fields: { 'Task Name': 'Bokslut', 'Byrå ID': '49' } },
        { id: 'recMoms', fields: { 'Task Name': 'Momsredovisning', 'Byrå ID': '49' } }
      ],
      ovriga: [
        { id: 'recGeo', fields: { Riskfaktor: 'Europa', 'Typ av riskfaktor': 'Geografiska riskfaktorer', 'PT/TF-relevans': 'PT', 'Byrå ID': '49' } },
        { id: 'recDist', fields: { Riskfaktor: 'Fysiskt möte', 'Typ av riskfaktor': 'Distrubutionskanaler', 'Byrå ID': '49' } },
        { id: 'recKund', fields: { Riskfaktor: 'Privatkunder', 'Typ av riskfaktor': 'Riskfaktorer kopplat till kund', 'PT/TF-relevans': 'PT', 'Byrå ID': '49' } }
      ],
      byraId: '49'
    });
