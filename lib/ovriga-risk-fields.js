/**
 * Extra Airtable-fält för övriga riskfaktorer (S×K, PT/TF, hot/sårbarheter).
...
const SCHEMA_FIELDS = [
  ...
  { name: 'AI-extra underlag', type: 'multilineText' }
];
...
function applyOvrigExtraAirtableFields(riskData, fields) {
  ...
  if (src.Hot !== undefined) out.Hot = src.Hot;
  if (src['Sårbarheter'] !== undefined) out['Sårbarheter'] = src['Sårbarheter'];
  if (src['AI-extra underlag'] !== undefined) out['AI-extra underlag'] = src['AI-extra underlag'];
  return out;
}
