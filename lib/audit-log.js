...
const ACTION_LABELS = Object.freeze({
  ...
  'kund_inneboende_arkiverad': 'Inneboende kundprofil arkiverad'
});
...
function parseSxK(raw) {
  ...
  if (!sannolikhet && !konsekvens && !obj.motivering_inneboende_risk && !obj.motivering_residual_risk) return null;
  ...
  return {
    ...
    motivering_inneboende_risk: String(obj.motivering_inneboende_risk || obj.motiveringInneboende || '').trim(),
    motivering_residual_risk: String(obj.motivering_residual_risk || obj.motiveringResidual || '').trim(),
    kraver_uppdaterad_motivering: obj.kraver_uppdaterad_motivering === true
  };
}
