...
module.exports = {
  ...
  drilldownKundBransch(records, bucketName, opts) {
    return KundBranschAggregat.drilldownKundBransch(records, bucketName, {
      asValues,
      parseKycJson,
      sniFilter: opts && opts.sniFilter
    });
  },
  drilldownHogriskBransch(records, namn, opts) {
    return KundBranschAggregat.drilldownHogriskBransch(records, namn, {
      asValues,
      parseKycJson,
      sniFilter: opts && opts.sniFilter
    });
