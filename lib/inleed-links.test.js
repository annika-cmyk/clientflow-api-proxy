...
describe('inleed-links', () => {
  ...
  it('läser signeringsdatum från dokument eller part', () => {
    assert.equal(extractSignedDate({ signed_at: '2026-08-21 14:03:00' }), '2026-08-21');
    assert.equal(extractSignedDate({
      parties: [
        { signed_at: '2026-08-20T09:00:00Z' },
        { signedAt: '2026-08-22 11:00:00' }
      ]
    }), '2026-08-22');
    assert.equal(extractSignedDate({ state: 'pending' }), '');
  });
