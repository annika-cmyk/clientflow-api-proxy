...
const NRA_SCENARIOS = [
  {
    ...
    tag: 'NRA kap. 4',
    desc: 'Kan er byrå, via era kunder eller tjänster, komma i kontakt med finansiering av terrorism? T.ex. kunder som är ideella föreningar, insamlingsorganisationer, trossamfund med internationell verksamhet, eller kunder som gör upprepade internationella överföringar utan tydlig affärsmässig motprestation.'
  },
  {
    id: 'nra-7-18-revisor',
    kind: 'yesno',
    ...
    tag: 'NRA 7.18',
    desc: 'Gäller framförallt revisorer som signerar revisionsberättelser — men kan även omfatta andra formella intyg, t.ex. kreditintyg till banker, intyg för myndighetsansökningar, eller liknande dokument som ger en transaktion eller struktur skenbar legitimitet. Utfärdar er byrå några sådana intyg?'
  },
  {
    id: 'nra-7-20-skatt',
    kind: 'yesno',
    title: 'Slussbolag',
    tag: 'NRA 7.20',
    desc: 'Ett slussbolag används för att flytta pengar genom skenbara transaktioner för att dölja varifrån de egentligen kommer. Har ni kunder med bolagsstrukturer utan tydligt affärssyfte, eller transaktionsmönster utan rimlig kommersiell förklaring?'
  },
  {
    ...
    tag: 'NRA 7.19',
    desc: 'Att bokföringstjänster kan användas för att få pengar från brottslig verksamhet att se ut som legitim affärsintäkt är en inneboende risk i redovisningsyrket — det gäller i praktiken alla byråer. Beskriv kort vilka kontroller ni har för att upptäcka det, t.ex. rimlighetsbedömning av underlag eller avvikelsehantering.'
  },
  {
    ...
    tag: 'NRA kap. 5',
    desc: 'Att era tjänster oavsiktligt kan användas för att tvätta pengar är en inneboende risk för alla som erbjuder redovisningstjänster. Beskriv kort hur ni minskar den risken, t.ex. genom avvikelsekontroll av transaktioner ni saknar anledning att ifrågasätta.'
  },
  {
    ...
    tag: '',
    desc: 'Härleds automatiskt från om tjänsten Betalningsuppdrag och betalningshantering (eller motsvarande) är aktiv i tjänstelistan. Det är ett faktum från er tjänstekatalog — inte en separat bedömning.'
  }
];
...
function resolveKlientmedelDerived(utforandeState, opts = {}) {
  ...
  if (hit && hit.active) {
    ...
    return {
      active: true,
      answer: 'ja',
      label: 'Ja — härlett från aktiv tjänst: ' + name,
      serviceName: name,
      mallId,
