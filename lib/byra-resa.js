...
const NRA_SCENARIOS = [
  {
    id: 'nra-kap-4-tf',
    title: 'Terrorfinansiering (NRA kap. 4)',
    desc: 'Är terrorfinansiering en relevant risk i byråns kundstock eller tjänster?'
  },
  {
    id: 'nra-7-19-bokforing',
    title: 'Bokföringsmodus (NRA 7.19)',
    desc: 'Förekommer risk för att redovisning används för att dölja penningtvätt?'
  },
  {
    id: 'nra-7-20-skatt',
    title: 'Skatt / slussbolag (NRA 7.20)',
    desc: 'Är skattebrott eller slussbolag relevanta i er kundstock?'
  },
  {
    id: 'nra-7-18-revisor',
    title: 'Revisor / gatekeeper (NRA 7.18)',
    desc: 'Påverkas ni av gatekeeper-risker kring revision eller intyg?'
  },
  {
    id: 'nra-kap-5-mojliggorare',
    title: 'Möjliggörare (NRA kap. 5)',
    desc: 'Kan byråns tjänster oavsiktligt möjliggöra penningtvätt för kunder?'
  },
  {
    id: 'nra-klientmedel-pml',
    title: 'Klientmedel / betalningsförmedling',
    desc: 'Hanterar ni klientmedel eller betalningsuppdrag där NRA lyfter förhöjd risk?'
  }
];
