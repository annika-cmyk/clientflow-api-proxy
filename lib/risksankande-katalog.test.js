...
describe('risksankande-katalog', () => {
  ...
  it('har katalogkort, API och kundkort kopplat till byråns lista', () => {
    ...
    assert.match(html, /styles\.css\?v=20260827b/);
    assert.match(kundriskerHtml, /ovriga-riskfaktorer\.js\?v=30/);
    assert.match(kundriskerHtml, /styles\.css\?v=20260827c/);
    assert.match(kundriskerHtml, /id="risksank-katalog-section"/);
    assert.match(kundriskerHtml, /Risksänkande faktorer/);
    assert.match(kundriskerHtml, /risksankande-katalog\.js\?v=3/);
    assert.match(kundriskerHtml, /risksank-katalog-ny-forklaring/);
    ...
    assert.match(adminJs, /risksank-katalog-ny-forklaring/);
    ...
    assert.match(kundkortHtml, /kundkort\.js\?v=16\.19/);
    assert.match(kundkortHtml, /styles\.css\?v=20260827c/);

    assert.match(css, /\.risksank-katalog-namn-wrap/);
  ...
  it('ritar katalogen som en kompakt rad med namn, förklaring och källa', () => {
    ...
    assert.doesNotMatch(html, /risk-kund-count-wrap/);
  });
});
