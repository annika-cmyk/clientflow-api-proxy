...
describe('risksankande-katalog', () => {
  ...
  it('har katalogkort, API och kundkort kopplat till byråns lista', () => {
    ...
    assert.match(html, /risksankande-katalog\.js\?v=2/);
    assert.match(html, /ovriga-riskfaktorer\.js\?v=21/);
    ...
    assert.match(kundHtml, /risksankande-katalog\.js\?v=2/);
    assert.match(kundHtml, /kundkort\.js\?v=16\.09/);
    assert.match(kundHtml, /styles\.css\?v=20260826b/);
