...
describe('riskanalys-tjanst-katalog', () => {
  ...
  it('katalogprompten kopierar inte spekulativa TF-hot', () => {
    assert.match(Katalog.PROMPT_RULES, /tfMotivering/);
    assert.match(Katalog.PROMPT_RULES, /spekulativa TF-scenarier/);
