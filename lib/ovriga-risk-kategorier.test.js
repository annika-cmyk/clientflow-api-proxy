...
describe('ovriga-risk-kategorier', () => {
  it('delar in övriga riskfaktorer i samarbete, kund och verksamhet', () => {
    ...
    assert.ok(Kat.labelsForCategory('kunden').includes('Kontantintensiv verksamhet'));
  ...
  it('isLinkedKundResidualFactor identifierar kontanter, krypto och betalkort', () => {
    ...
    assert.equal(Kat.airtableTypForLinkedKundResidual('Kunder med transaktioner via Betalkort'), 'Riskfaktorer kopplat till kund');
  });
