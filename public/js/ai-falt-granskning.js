...
- LÄNGD OCH PEDAGOGIK («AML för dummies»): Varje motivering ska vara 4–8 meningar (minst ca 280 tecken). Förklara i klarspråk så en nyanställd förstår utan AML-bakgrund. En kort S-mening + en kort K-mening räcker INTE.
- motiveringInneboende: Förklara VARFÖR sannolikheten är som den är (hot/sårbarhet, typisk modus) och VARFÖR konsekvensen är som den är (skada, tillsyn, legitimering). Soft-score inte S/K till 2–3 när exponeringen motiverar högre.
- motiveringResidual: Förklara HUR de konkreta åtgärderna/kontrollerna sänkt S och/eller K — nämn kontrollerna och gärna hur de dokumenteras. Inte bara «genom strikta kontroller». Minst ca 280 tecken. Om residual är Hög eller Oacceptabel: nämn riskaptit eller fattat beslut.
...
- Skriv inte «sannolikheten är förhöjd» eller «konsekvensen är betydande». Rätt: «Sannolikheten bedöms till 3 (medel) … Konsekvensen bedöms till 4 (allvarlig) …» Om du nämner inneboende/residual risknivå ska den stämma med S×K.`;
...
- Ta fram DITT kompletta förslag för ALLA fält: beskrivning (4–7 meningar), S×K, motivering av S/K (4–8 meningar vardera), residual, motivering av residual, fullständiga listor för hot/sårbarheter/åtgärder (med källor på hot). Antalet poster enligt ANTAL-regeln.
