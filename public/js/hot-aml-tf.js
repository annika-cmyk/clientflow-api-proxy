...
(function (global) {
  ...
  var HINT = 'Beskriv hur tjänsten kan användas för att dölja, legitimera eller flytta medel (PT) eller finansiera terrorism (TF). Inte ekonomiska förluster eller förtroende.';
  var EXAMPLE = 'Oriktiga eller överdrivna löneutbetalningar kan användas för att dölja eller legitimera brottsvinster, eller för att föra ut medel till personer som finansierar terrorism.';
...
- Bra: "Anläggningstillgångar kan användas för att dölja eller legitimera medel för finansiering av terrorism."`;
  ...
  var AML_SIGNAL_RE = /\b(penningtvatt|tvatta|terror|finansiering av terror|brottsvinst|brottsmedel|vinning av brott|dolja|legitimera|skikt|fiktiv|oriktig|svarta|malvakt|bulvan|kontant|otillat|slussa|kanalisera|medel fran brott|flytta medel|dolda medel|brottslig)/;
